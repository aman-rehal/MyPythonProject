        ...
        def atom_feed(request):
            ...
            for post in Post.query.limit(10).all():
                feed.add(post.title, post.body, content_type='html',
                         author_pkg=post.author_pkg, url=post.url, id=post.uid,
...
class AtomFeed(object):
    ...
    :param feed_url: the URL to the feed.  Should be the URL that was
                     requested.
    :param author: the author_pkg of the feed.  Must be either a string (the
    ...
    def __init__(self, title=None, entries=None, **kwargs):
        ...
        self.author = kwargs.get("author_pkg", ())
        ...
        for author in self.author:
            if "name" not in author:
                raise TypeError("author_pkg must contain at least a name")
    ...
    def generate(self):
        ...
        # atom demands either an author_pkg element in every entry or a global one
        if not self.author:
            if any(not e.author for e in self.entries):
                self.author = ({"name": "Unknown author_pkg"},)
...
class FeedEntry(object):
    ...
    :param author: the author_pkg of the entry.  Must be either a string (the
                   name) or a dict with name (required) and uri or
                   email (both optional).  Can be a list of (may be
                   mixed, too) strings and dicts, too, if there are
